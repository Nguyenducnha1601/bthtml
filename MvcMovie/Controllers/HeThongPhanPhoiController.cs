...
namespace MvcMovie.Controllers
{
    public class HeThongPhanPhoiController : Controller
    {
        ...
        {
            return View(await _context.HeThongPhanPhoiHeThongPhanPhoi.ToListAsync());
        }
        ...
        public async Task<IActionResult> Details(string id)
        {
            ...
            var heThongPhanPhoi = await _context.HeThongPhanPhoiHeThongPhanPhoi
        ...
        public async Task<IActionResult> Edit(string id)
        {
            ...
            var heThongPhanPhoi = await _context.HeThongPhanPhoiHeThongPhanPhoi.FindAsync(id);
            if (heThongPhanPhoi == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> DeleteConfirmed(string id)
        {
            ...
            if (heThongPhanPhoi != null)
            {
                _context.HeThongPhanPhoiHeThongPhanPhoi.Remove(heThongPhanPhoi);
            }
        ...
        {
            return _context.HeThongPhanPhoiHeThongPhanPhoi.Any(e => e.MaHTPP == id);
        }
    }
}
